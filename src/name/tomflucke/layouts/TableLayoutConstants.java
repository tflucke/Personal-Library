...
public interface TableLayoutConstants
	{
		...
		/**
		 * Indicates that the row/column should be allocated just enough space
		 * to accomidate the preferred size of all components contained
		 * completely within this row/column.
		 */
		public static final double PREFERRED = -2.0;

		/**
		 * Indicates that the row/column should be allocated just enough space
		 * to accomidate the minimum size of all components contained completely
