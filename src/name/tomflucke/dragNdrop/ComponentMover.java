...
/*
 * Written by Rob Camick @ http://tips4java.wordpress.com/2009/06/14/moving-windows/
 */
...
public class ComponentMover extends MouseAdapter
{
	...
	protected Dimension snapSize = new Dimension(1, 1);
	private Insets edgeInsets = new Insets(0, 0, 0, 0);
	private boolean changeCursor = true;
	private boolean autoLayout = false;

	protected ArrayList<ChangeListener> listeners;
	private Class<? extends Component> destinationClass;
	...
	private int validButtons = MouseEvent.BUTTON1;
	 ...
	 */
	public ComponentMover(Class<? extends Component> destinationClass, Component... components)
	{
		this();
	...
	public void setMouseButtons(int mouseButton)
	{
		validButtons = mouseButton;
	}
	...
	private void setupForDragging(MouseEvent me)
	{
		...
		// forward events to destination component
		{
		...
		// Making sure autoscrolls is false will allow for smoother
		// dragging of
	...
	public void mouseDragged(MouseEvent me)
	{
		...
		moveComponent(destination, location, dragX, dragY);
	}

	protected void moveComponent(Component comp, Point origin, int dragX, int dragY)
	{
		int locationX = origin.x + dragX;
		int locationY = origin.y + dragY;

		// Mouse dragged events are not generated for every pixel the
		// mouse
		...
		while (locationX + comp.getSize().width + edgeInsets.right > d.width)
		{
			locationX -= snapSize.width;
		}

		while (locationY + comp.getSize().height + edgeInsets.bottom > d.height)
		{
			locationY -= snapSize.height;
		}
	 ...
	 */
	protected int getDragDistance(int larger, int smaller, int snapSize)
	{
