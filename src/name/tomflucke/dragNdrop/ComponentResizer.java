...
/*
 * Written by Rob Camick @ http://tips4java.wordpress.com/2009/09/13/resizing-components/
 */
...
public class ComponentResizer extends MouseAdapter
{
	...
	public void mouseMoved(MouseEvent e)
	{
		...
		else if (cursors.containsKey(direction))
	...
	public void mousePressed(MouseEvent e)
	{
		...
		// based
		// on the original bounds of the component and mouse pressed
		// location.
	...
	protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current)
	{
		...
		// Resizing the West or North border affects the size and
		// location
